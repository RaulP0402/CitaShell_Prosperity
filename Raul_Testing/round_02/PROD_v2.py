...
from datamodel import OrderDepth, ProsperityEncoder, Symbol,UserId, TradingState, Order, Listing, Trade, Observation, ConversionObservation
from typing import List, Any, Dict, Tuple
import string
import json
from dataclasses import dataclass
...
class GeneralOrder:
    ...
    def from_observation(
        ...
        if position < 0:
            ...
            price = obs.bid - obs.transportFees
            quantity = position
